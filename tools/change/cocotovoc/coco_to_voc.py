...
def main():
    ...
    mkr(image_dir)
    mkr(anno_dir)
    origin_image_dir = 'S:\changebackbone\yolox-pytorch-main\VOCdevkit\VOC2007\JPEGImages'  # step 2原始的coco的图像存放位置
    origin_anno_dir = 'G:/change/cocotovoc'  # step 3 原始的coco的标注存放位置
